...
Shader "TEST"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin]_WC4_Alliance_Statue_Diffuse("WC4_Alliance_Statue_Diffuse", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _WC4_Alliance_Statue_Diffuse_ST;
			...
			#endif
			CBUFFER_END
			sampler2D _WC4_Alliance_Statue_Diffuse;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_WC4_Alliance_Statue_Diffuse = IN.ase_texcoord7.xy * _WC4_Alliance_Statue_Diffuse_ST.xy + _WC4_Alliance_Statue_Diffuse_ST.zw;
				
				float3 Albedo = tex2D( _WC4_Alliance_Statue_Diffuse, uv_WC4_Alliance_Statue_Diffuse ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_WC4_Alliance_Statue_Diffuse = IN.ase_texcoord2.xy * _WC4_Alliance_Statue_Diffuse_ST.xy + _WC4_Alliance_Statue_Diffuse_ST.zw;
...
/*ASEBEGIN
Version=18500
0;612;1061;387;1240.917;259.95;1.681844;True;False
Node;AmplifyShaderEditor.SamplerNode;7;-394.95,-27.85558;Inherit;True;Property;_WC4_Alliance_Statue_Diffuse;WC4_Alliance_Statue_Diffuse;0;0;Create;True;0;0;False;0;False;-1;d9ccf91ac32a9cd4389a97051cbd1724;d9ccf91ac32a9cd4389a97051cbd1724;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=16715A9DCF36E9D60885C6229026A25393D77378